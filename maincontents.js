   ...
   // alert(strContentsName);
    ...
    switch (strContentsName)
    {
        ...
        case "Home":
           ...
           break;
        case "Menu":
            if(readCookie("screen")=="screen1"){
                location.href = "../../menu.html";
            }
            else if (readCookie("screen")=="screen2") {
                location.href = "../../menu-2.html";
            }
            else {
                location.href = "../../menu-3.html";
            }
            break;
        case "Services":
            //PlaySpeech(speak[2]);
        ...
        case "screen1":
            //PlaySpeech(speak[3]);
            location.href = "menu.html";
            writeCookie("screen", "screen1", 1);
            break;
        case "screen2":
            //PlaySpeech(speak[3]);
            location.href = "menu-2.html";
            writeCookie("screen", "screen2", 1);
            break;
        case "screen3":
            //PlaySpeech(speak[3]);
            location.href = "menu-3.html";
            writeCookie("screen", "screen3", 1);
            break;
